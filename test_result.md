...
user_problem_statement: |
  Enhance existing workflow builder with:
  1. New Program Configuration stage (after Lead Source Integration) for selecting programs like MBA, MS in Cybersecurity
  2. Make Application Requirements, Admission Criteria, Scholarship Rules program-specific
  3. Add Analytics Dashboard showing time saved, efficiency metrics, processing data
  4. Add Export functionality (CSV/XLSX) on each screen from stage 2 onwards
  5. Add Bulk Selection features for leads management
  6. Only frontend implementation required, no backend changes needed
...
frontend:
  ...
  - task: "Program-specific workflow configuration"
    implemented: true
    working: true
    file: "/app/frontend/src/screens/WorkflowBuilder.js"
    stuck_count: 0
